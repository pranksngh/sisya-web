...
const AddTeacher = () => {
  ...
  const handleFileChange = (e) => {
    ...
    if (file) {
        ...
        reader.onloadend = () => {
          ...
          setFormData({ ...formData, imageData: reader.result }); // Store the base64 string in formData
        }
  ...
  const handleSubmit = (e) => {
    ...
    const payload = {
        ...
        searchTags: "",
        languages: "",
        Grades: formData.grades, // Submit the array of grades
        ...
        subjectRecords: selectedSubjects.map(s => ({
          comment: s.comment,
  ...
  >
              {["Class 1", "Class 2", "Class 3", "Class 4", "Class 5", "Class 6", "Class 7", "Class 8", "Class 9","Class 10", "Class 11","Class 12"].map((cls) => (
                <Chip
                  ...
                  sx={{
                    marginTop:10,
                    backgroundColor: formData.classes.includes(cls) ? "primary.main" : "default",
                    color: formData.classes.includes(cls) ? "white" : "black",
                    "&:hover": {
                      backgroundColor: formData.classes.includes(cls)
                        ? "primary.dark"
                        : "grey.300",
                    },
                  }}
