...
import { Button, Dialog, DialogActions, DialogContent, DialogTitle, TextField, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Pagination, Typography, InputAdornment, TablePagination } from '@mui/material';
import { getUser } from '../../Functions/Login';


const MentorLeaveRecord = () => {
    const user = getUser();
    ...
    return (
      <div className="data-table-container">
        <ToastContainer />
        <Typography variant="h4" gutterBottom>Mentor Leave Requests</Typography>
  ...
  export default MentorLeaveRecord;
